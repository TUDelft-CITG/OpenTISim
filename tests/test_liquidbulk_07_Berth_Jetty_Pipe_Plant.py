...
def test_liquidbulk_07_Berth_Jetty_Pipe_Plant():
	...
	# plant data 
	opentisim.liquidbulk.h2retrieval_lh2_data['delivery_time'] = 2 
	opentisim.liquidbulk.h2retrieval_lh2_data['lifespan'] = 20  #
	opentisim.liquidbulk.h2retrieval_lh2_data['unit_rate'] = 59_000_000  
	opentisim.liquidbulk.h2retrieval_lh2_data['mobilisation_min'] = 200_000  
	opentisim.liquidbulk.h2retrieval_lh2_data['mobilisation_perc'] = 0.003      
	opentisim.liquidbulk.h2retrieval_lh2_data['maintenance_perc'] = 0.015 
	opentisim.liquidbulk.h2retrieval_lh2_data['crew_min'] = 3  
	opentisim.liquidbulk.h2retrieval_lh2_data['crew_for5'] = 1    
	opentisim.liquidbulk.h2retrieval_lh2_data['insurance_perc'] = 0.01  
	opentisim.liquidbulk.h2retrieval_lh2_data['consumption'] = 600        
	opentisim.liquidbulk.h2retrieval_lh2_data['capacity'] = 137
