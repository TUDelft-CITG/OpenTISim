...
def test_liquidbulk_07_Berth_Jetty_Pipe_Plant():
	...
	terminal elements are suggested if a Berth, Jetty, Pipeline and plant are build, check also the berth occupancy, waiting    	factor, throughput and costs - in this testcase the lifecycle is run in year-by-year stepping. Checks have been done for    	years 2023 and 2027.
	"""
	import pandas as pd
	import opentisim
	import numpy as np
	...
	# plant data 
	opentisim.liquidbulk.h2retrieval_lh2_data['delivery_time'] = 2 #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['lifespan'] = 20  #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['unit_rate'] = 59_000_000  #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['mobilisation_min'] = 200_000  #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['mobilisation_perc'] = 0.003   #[Abrahamse 2021]    
	opentisim.liquidbulk.h2retrieval_lh2_data['maintenance_perc'] = 0.015 #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['crew_min'] = 3  #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['crew_for5'] = 1    #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['insurance_perc'] = 0.01  #[Abrahamse 2021] 
	opentisim.liquidbulk.h2retrieval_lh2_data['consumption'] = 600 #[Abrahamse 2021]        
	opentisim.liquidbulk.h2retrieval_lh2_data['capacity'] = 137#[Abrahamse 2021]    
